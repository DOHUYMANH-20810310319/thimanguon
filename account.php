                                    ...
                                    while ($row2 = mysqli_fetch_assoc($result2)) {
                                        ...
                                        <div class="review__details"  style="width:400px;">
                                            ...
                                            <div class="review__date">
                                                <span>Commandé le ' . date('j', strtotime($row2["date_cmd"])) . ' ' . date('M', strtotime($row2["date_cmd"])) . ', ' . date('Y', strtotime($row2["date_cmd"])) . ' à ' . date('H:i', strtotime($row2["date_cmd"])) . '</span>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                <div class="copyright">
                                    <p>© 2022 <a href="#">Phát triển bởi Mạnh và Lâm</a>
                                        </p>
                                </div>
