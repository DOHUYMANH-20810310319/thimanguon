                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>Bảng điều khiển
                                    <div class="page-title-subheading">Quản lý khách hàng, đơn đặt hàng và nội dung trên trang web của bạn.
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-3 widget-content bg-arielle-smile">
                                <div class="widget-content-wrapper text-white">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white"><span><?php echo $totalCommandes; ?> VND</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="tabs-eg-77">
                                            <h6 class="text-muted text-uppercase font-size-md opacity-5 font-weight-normal">Mua hàng từ khách hàng trung thành</h6>
                                                            ...
                                                            echo '
                                                                    ...
                                                                    <div class="widget-content-right">
                                                                        <div class="font-size-xlg text-muted">
                                                                            <span>' . $achat . '</span>
                                                                            <small class="opacity-5 pr-1">VND</small>
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                                    </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-3 widget-content">
                                <div class="widget-content-outer">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Thể loại</div>
                                            <div class="widget-subheading">Số danh mục và danh mục con</div>
                                        </div>
                                        <div class="widget-content-right">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-3 widget-content">
                                <div class="widget-content-outer">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Việc bán hàng</div>
                                            <div class="widget-subheading">Phần trăm doanh thu</div>
                                        </div>
                                        <div class="widget-content-right">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">Lệnh hoạt động
                                </div>
