                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                ...
                                <nav class="bradcaump-inner">
                                    ...
                                    <br><br>
                                    <span class="breadcrumb-item active">Vous avez déjà un compte? </span>
                                    <a class="continuer" href="login-register.php"> Connectez-vous </a>
                                    <span class="breadcrumb-item active">pour voir les articles dans votre panier.</span>                                
                                </nav>
                            </div>
                        </div>
                    </div>
        ...
        <div class="cart-main-area ptb--120 bg__white">
            <div class="container">
                ...
                for ($i = 0; $i < count($_SESSION['panier']['idProduit']); $i++) {
                    ...
                    echo '<td class="product-price"><span class="amount">' . $prix . ' VND</span></td>';
                                        ...
                                        <table>
                                             <tbody>
                                                <tr class="cart-subtotal">
                                                    <th>Total</th>
                                                    <td><span id="sous_amount" class="amount">' . $totalFinal . ' VND</span></td>
                                                </tr>
                                                <tr class="shipping">
                                                   <th>Livraison</th>
                                                   <td>';
                                                            ...
                                                            <ul id="shipping_method">
                                                                <li>
                                                                    ...
                                                                    <label for="' . $row2['nom_type'] . '">
                                                                        ' . $row2['nom_type'] . ': <span class="amount">' . $row2['prix_livraison'] . ' VND</span>
                                                                    </label>
                                                                </li>';
                $row2 = mysqli_fetch_assoc($result2);
                echo '<li>
                                                ...
                                                <tr class="order-total">
                                                    ...
                                                    <td>
                                                        <strong><span id="final_amount" class="amount ">' . $bilan . ' VND</span></strong>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <div class="wc-proceed-to-checkout">
                                            <a href="login-register.php?cart=1">Finaliser ma commande</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
