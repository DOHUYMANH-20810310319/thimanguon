                        ...
                        <div class="col-md-8 col-lg-8 col-sm-6 col-xs-6">
                            ...
                            <div class="mobile-menu clearfix visible-xs visible-sm">
                                <nav id="mobile_dropdown">
                                    <ul>
                                        <li><a href="index.php">Giao diện chính</a></li>
                                        <li><a href="shop.php">Sản phẩm</a></li>
                                        <li><a href="help.php">Hỗ trợ</a></li>
                                        <li><a href="contact.php">Liêm hệ</a></li>
                                        <?php if (isset($_SESSION["id_user"])) echo '<li><a href="destroy.php">Đăng xuất</a></li>'; ?>
                ...
                while ($rowp = mysqli_fetch_array($query)) {
                    ...
                    echo '
                            ...
                            <div class="shp__pro__details">
                                ...
                                <span class="shp__price">Giá : ' . $prix . ' VND</span>
                            </div>
                    ...
                    <div class="col-md-9 col-lg-9 col-sm-8 col-xs-12 float-left-style">
                        ...
                        <div class="slider__container slider--one">
                            <div class="slider__activation__wrap owl-carousel owl-theme">
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit slider-text-right" style="background: rgba(0, 0, 0, 0) url(images/slider/2.jpg) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-10 col-lg-8 col-md-offset-2 col-lg-offset-4 col-sm-12 col-xs-12">
                                                <div class="slider__inner">
                                                    <h1>Sản phẩm mới <span class="text--theme"></span></h1>
                                ...
                                <!-- End Single Slide -->
                                <!-- Start Single Slide -->
                                <div class="slide slider__full--screen slider-height-inherit  slider-text-left" style="background: rgba(0, 0, 0, 0) url(images/slider/3.jpg) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                                ...
                                <div class="slide slider__full--screen slider-height-inherit  slider-text-left" style="background: rgba(0, 0, 0, 0) url(images/slider/1.jpg) no-repeat scroll center center / cover ;">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8 col-lg-8 col-sm-12 col-xs-12">
                                                <div class="slider__inner">
                    ...
                    echo ' </div>
                                                   <div class="product__details">
                                                        ...
                                                        if($new_price<$row['prix']){
                                                            ...
                                                            echo'<li class="old__price">' . $row['prix'] . ' VND</li>
                                                            
                                                           
                                                            <li class="new__price">' . $new_price . ' VND</li>';}
                                                            else {
                                                                 echo'<li class="new__price" >' . $row['prix'] . ' VND</li>';
                                                            }
                                                       echo' </ul>
                                                    </div>
                                                </div>
                ...
                <div class="row">
                    <div class="footer__container clearfix">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            <div class="address-text">
                                                <p>235 Hoàng Quốc Việt <br> Bắc Từ Liêm, Hà Nội</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="address-icon">
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 smt-30 xmt-30">
                            <div class="ft__widget">
                                <h2 class="ft__title">Loại</h2>
                                <ul class="footer-categories">
                                    <li><a href="shop-sidebar.html">Loại sản phẩm</a></li>
                                    <li><a href="shop-sidebar.html">Manga</a></li>
                                    <li><a href="shop-sidebar.html">Shounen</a></li>
                                    <li><a href="shop-sidebar.html">Jump</a></li>
                                    <li><a href="shop-sidebar.html">Comedy</a></li>
                                    <li><a href="shop-sidebar.html">Horro</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Start Single Footer Widget -->
                        ...
                        <div class="col-md-3 col-lg-3 col-lg-offset-1 col-sm-6 smt-30 xmt-30">
                            <div class="ft__widget">
                                ...
                                <div class="newsletter__form">
                                    <p>Đăng ký nhận bản tin của chúng tôi và được giảm 10% cho lần mua hàng đầu tiên của bạn.</p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                <div class="copyright">
                                    <p>© 2022 <a href="#">Nhóm 2 phát triển</a>
                                        Đã đăng ký bản quyền</p>
                                </div>
                                <ul class="footer__menu">
                                    <li><a href="index.php">Chào mừng</a></li>
                    ...
                    <div class="modal-body">
                        <div class="modal-product">
                            ...
                            <div class="product-info">
                                ...
                                Được thiết kế đơn giản và làm từ vật liệu chất lượng cao. Sự kết hợp hình học và vật liệu kiểu dáng đẹp của nó tạo ra một cái nhìn hiện đại.
                                </div>
