...
<body>
    ...
    <div class="wrapper fixed__footer">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 smt-30 xmt-30">
                        <div class="htc__product__details__inner">
                            ...
                            <div class="pro__dtl__color">
                                <h2 class="title__5"><b>Sản phẩm</b> : ';
        ...
        if ($row['promo'] != 0) {
            echo ' <li class="old__prize">' . $row['prix'] . ' VND</li>
                                <li>' . $row['prix'] * (1 - $row['promo'] / 100) . ' VND</li>';
        } else {
            echo '<li>' . $row['prix'] . ' VND</li>';
        }
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <ul class="product__deatils__tab mb--60" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#reviews" role="tab" data-toggle="tab">Để ý</a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div role="tabpanel" id="description" class="product__tab__content fade in active">
                                <div class="product__description__wrap">
                                    ...
                                    <div class="pro__feature">
                                        <h2 class="title__6">Bảng kỹ thuật</h2>
                                ...
                                <div class="footer-address">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="address-text">
                                                <a href="#"> sasukeowl01@gmail.com</a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="address-icon">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            <div class="copyright__inner">
                                <div class="copyright">
                                    <p>© 2022 <a href="#">Làm bởi Mạnh và Lâm</a>
                                        </p>
                                </div>
