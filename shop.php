                                       ...
                                       ?>
                                        ...
                                        <div class="single__filter" style="width: 400px;margin-top: 5px;">
                                            <h2 class="side-title s5" style="width:300px;">Sắp xếp theo</h2><br>
                                             ...
                                             <div class="radio" style="width:400px;">
                                                <input type="radio" name="sortby" value="nomaz" ><label style="font-size:16px;"> Từ: A đến Z
                                                </label>
                                                </div>
                                             <div class="radio">
                                                <input type="radio" name="sortby" value="nomza" ><label style="font-size:16px;"> Từ: Z đến A
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <input type="radio" name="sortby" value="prixc" ><label style="font-size:16px;"> Giá: dưới lên
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <input type="radio" name="sortby" value="prixd" ><label style="font-size:16px;"> Giá: trên xuống
                                                </label>
                                            </div>
                                        ...
                                        <div class="single__filter" >
                                         ...
                                         <div class="single__filter" style="width: 400px;">
                                            <h2 class="side-title s4" >chuyển từ</h2><br>
                                          
                                             <div class="checkbox" style="width:400px;">
                                                <input type="checkbox" name="expedie[]" value="1" ><label style="font-size:16px;"> Bán từ UK
                                                </label>
                                                </div>
                                             <div class="checkbox">
                                                <input type="checkbox" name="expedie[]" value="2" ><label style="font-size:16px;"> Hàng nước ngoài
                                                </label>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    <div class="footer__container clearfix">
                        ...
                        <div class="col-md-3 col-lg-2 col-sm-6 smt-30 xmt-30">
                            <div class="ft__widget">
                                <h2 class="ft__title">Sản phẩm</h2>
                                <ul class="footer-categories">
                                    <li><a href="shop-sidebar.html">Các sản phẩm</a></li>
                                    ...
                                    <li><a href="shop-sidebar.html">Tản nhiệt</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Start Single Footer Widget -->
